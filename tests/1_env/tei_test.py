...
def test_tei(script_loc, tmp_path) -> None:  # type: ignore
    ...
    expected = '<ns0:biblStruct xml:id="b116" ID="TEST_ID">'
    assert expected in actual

    expected = 'theoretical rationale <ns0:ref type="bibr" target="#b116" ID="TEST_ID">(Whetten, 1989)</ns0:ref>, which is critical '
    assert expected in actual
