...
class CustomName(PDFGetManPackageBaseClass):
    ...
    def __init__(self, *, pdf_get_man_operation: 'colrev.ops.pdf_get_man.PDFGetMan', settings: 'dict', logger: 'Optional[logging.Logger]' = None, verbose_mode: bool = False) -> 'None':
