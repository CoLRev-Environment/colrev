...
import colrev.packages.prep.exclude_languages
...
) -> colrev.packages.prep.exclude_languages.ExcludeLanguagesPrep:
    """Fixture returning an ExcludeLanguagesPrep instance"""
    settings = {"endpoint": "colrev.exclude_languages"}
    elp_instance = colrev.packages.prep.exclude_languages.ExcludeLanguagesPrep(
...
def test_prep_exclude_languages(
    elp_elp: colrev.packages.prep.exclude_languages.ExcludeLanguagesPrep,
    input_value: dict,
    expected: dict,
) -> None:
