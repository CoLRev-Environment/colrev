...
import colrev.packages.prep.year_vol_iss_prep
...
def get_yvip(
...
) -> colrev.packages.prep.year_vol_iss_prep.YearVolIssPrep:
    ...
    yvip = colrev.packages.prep.year_vol_iss_prep.YearVolIssPrep(
