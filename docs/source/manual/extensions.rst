...
They contain an ``.colrev_endpoints.json`` file in the top-level directory (`colrev <https://github.com/CoLRev-Ecosystem/colrev/blob/main/.colrev_endpoints.json>`_ provides an example).
...
The development status is automatically added to the `package_status.json <https://github.com/CoLRev-Ecosystem/colrev/blob/main/colrev/template/package_status.json>`_ and can be updated manually once the review is completed.
