...
This project is licensed under the MIT License - see the `LICENSE <https://github.com/CoLRev-Environment/colrev/blob/main/colrev/packages/plos/LICENSE>`_ file for details.
