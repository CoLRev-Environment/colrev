...
Data from the OSF open platform can be retrieved with the URL from the `https://www.osf.io/ <https://api.osf.io/v2/nodes/?filter>`_.
...
The API key can be requested via the `OSF settings page <https://accounts.osf.io/login?service=https://osf.io/settings/tokens/>`_.
