...
For example, this can be done using the `EXCLUDE annotation <https://github.com/CoLRev-Environment/colrev/blob/main/colrev/ops/built_in/data/paper_md.md>`_ in a paper.
