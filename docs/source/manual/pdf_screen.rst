...
For example, this can be done using the `EXCLUDE annotation <https://github.com/CoLRev-Ecosystem/colrev/blob/main/colrev/ops/built_in/data/manuscript.py#L405>`_ in a synthesis document.
