...
It does not explain the design and architecture of CoLRev, which are covered in the `technical documentation <../technical_documentation/colrev.html>`_ and the `API reference <../technical_documentation/api.html>`_.
