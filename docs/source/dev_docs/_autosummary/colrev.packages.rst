...
.. autosummary::
   ...
   colrev.packages.abi_inform_proquest
   colrev.packages.acm_digital_library
   colrev.packages.add_journal_ranking
   colrev.packages.ais_library
   ...
   colrev.packages.conditional_prescreen
   ...
   colrev.packages.eric
   colrev.packages.europe_pmc
   colrev.packages.exclude_collections
   colrev.packages.exclude_complementary_materials
   colrev.packages.exclude_languages
   colrev.packages.exclude_non_latin_alphabets
   colrev.packages.export_man_prep
   ...
   colrev.packages.open_citations_forward_search
   ...
   colrev.packages.pubmed
   colrev.packages.qualitative_systematic_review
   colrev.packages.remove_broken_ids
   colrev.packages.remove_coverpage
   colrev.packages.remove_last_page
   colrev.packages.remove_urls_with_500_errors
   colrev.packages.scientometric
   ...
   colrev.packages.source_specific_prep
   colrev.packages.springer_link
   colrev.packages.structured
   colrev.packages.sync
   colrev.packages.synergy_datasets
