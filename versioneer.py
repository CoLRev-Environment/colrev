...
def get_config_from_root(root):
    ...
    with open(setup_cfg, encoding="utf8") as cfg_file:
...
def git_get_keywords(versionfile_abs):
    ...
    keywords = {}
    try:
        with open(versionfile_abs, "r", encoding="utf8") as fobj:
            for line in fobj:
...
def do_vcs_install(manifest_in, versionfile_source, ipy):
    ...
    present = False
    try:
        with open(".gitattributes", encoding="utf8") as fobj:
            for line in fobj:
        ...
        pass
    if not present:
        with open(".gitattributes", "a+", encoding="utf8") as fobj:
    ...
    if "cx_Freeze" in sys.modules:  # cx_freeze enabled?
        ...
        class cmd_build_exe(_build_exe):
            def run(self):
                ...
                with open(cfg.versionfile_source, "w", encoding="utf8") as f:
...
def do_setup():
    ...
    try:
        ...
        if isinstance(e, (EnvironmentError, configparser.NoSectionError)):
            ...
            with open(os.path.join(root, "setup.cfg"), "a", encoding="utf8") as f:
    ...
    if os.path.exists(ipy):
        try:
            with open(ipy, encoding="utf8") as f:
                old = f.read()
        except OSError:
            old = ""
        ...
        if OLD_SNIPPET in old:
            ...
            with open(ipy, "w", encoding="utf8") as f:
                f.write(old.replace(OLD_SNIPPET, snippet))
        elif snippet not in old:
            print(" appending to %s" % ipy)
            with open(ipy, "a", encoding="utf8") as f:
                f.write(snippet)
        else:
    ...
    simple_includes = set()
    try:
        with open(manifest_in, encoding="utf8") as f:
            for line in f:
    ...
    if "versioneer.py" not in simple_includes:
        ...
        with open(manifest_in, "a", encoding="utf8") as f:
...
def scan_setup_py():
    ...
    setters = False
    errors = 0
    with open("setup.py", encoding="utf8") as f:
