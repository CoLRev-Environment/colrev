...
- Change released to `True` for the migration script in `ops/upgrade.py`, add a new migration script (update `settings.py - _add_missing_attributes()` to prevent exceptions)
