...
import colrev.packages.semanticscholar.semanticscholar_utils as connector_utils
...
from colrev.packages.semanticscholar.semanticscholar_ui import SemanticScholarUI
