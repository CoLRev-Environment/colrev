...
import colrev.packages.search_sources.ieee_api
...
class IEEEXploreSearchSource(JsonSchemaMixin):
    ...
    # pylint: disable=colrev-missed-constant-usage
    def _run_api_query(self) -> colrev.packages.search_sources.ieee_api.XPLORE:
        api_key = self._get_api_key()
        query = colrev.packages.search_sources.ieee_api.XPLORE(api_key)
        query.dataType("json")
