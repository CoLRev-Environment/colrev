...
def visualization_time(data):
    ...
    fig.update_yaxes(
        title_text="Count", title_font={"size": 20}, tickfont=dict(size=20)
    )
    return fig
    ...
    children=[
        html.Div(
            ...
            children=[
                ...
                dcc.Input(
                    type="text", id="search", value="", placeholder="  Search for..."
                ),
            ],
        ),
        html.Div(
            [
                html.Label(
                    ...
                    style={"fontSize": 40, "font-weight": "bold"},
                ),
                dash_table.DataTable(
                    ...
                    style_header={"font-weight": "bold", "backgroundColor": "#a4ce4a"},
                ),
            ]
        ),
